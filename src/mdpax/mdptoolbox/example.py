...
def forest(
    ...
    if is_sparse:
        warnings.warn(
            "Using experimental JAX sparse matrix support. API may change in future versions. See https://jax.readthedocs.io/en/latest/jax.experimental.sparse.html for more information.",
            UserWarning
        )
